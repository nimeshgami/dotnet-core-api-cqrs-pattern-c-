...
using ExampleProject.Application.Orders.ChangeCustomerOrder;
using ExampleProject.Application.Orders.GetCustomerOrderDetails;
using ExampleProject.Application.Orders.GetCustomerOrders;
using ExampleProject.Application.Orders.PlaceCustomerOrder;
using ExampleProject.Application.Orders.RemoveCustomerOrder;

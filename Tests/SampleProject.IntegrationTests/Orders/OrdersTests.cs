...
using ExampleProject.Application.Orders.GetCustomerOrderDetails;
using ExampleProject.Application.Orders.PlaceCustomerOrder;
using ExampleProject.Application.Payments;
...
namespace ExampleProject.IntegrationTests.Orders
{
    [TestFixture]
    public class OrdersTests : TestBase
    {
        ...
        public async Task PlaceOrder_Test()
        {
            ...
            var customer = await CommandsExecutor.Execute(new RegisterCustomerCommand(customerEmail, "Example Customer"));
